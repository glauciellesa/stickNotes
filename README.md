...
Worked with localStorage to manage sticknote storage
I used **JSON stringify** to convert data to string to keep the data in localStorage and then **JSON parse()** to retrieve my data in the type I wanted.
